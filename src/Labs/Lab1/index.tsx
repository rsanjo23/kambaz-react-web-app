        ...
        <div id="wd-lab1">
            ...
            <div id="wd-lists">
                ...
                <ol id="wd-your-favorite-recipe">
                    ...
                    <li>Strain pasta</li>
                    <li>Add peanut butter to bowl</li>
                    <li>Add chili oil</li>
                    <li>Add soy sauce</li>
                    <li>Add sugar</li>
                    <li>Mix</li>
                    <li>Combine sauce and pasta and enjoy!</li>
                </ol>
            ...
            <div id="wd-forms">
                ...
                <a href="https://github.com/rsanjo23/kambaz-react-web-app" id="wd-github">Ryan's GitHub</a>
            </div>
        </div>
    );
}